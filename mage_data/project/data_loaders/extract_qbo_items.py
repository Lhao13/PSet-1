...
def execute(*args, **kwargs):
    ...
    logger.info("[AUTH] Starting QBO Item extraction")
    ...
    for segment in segments:
        ...
        logger.info(f"[EXTRACT] Item segment -> {start} to {end}")
        ...
        while True:
            ...
            # QuickBooks a veces devuelve dict cuando hay 1 resultado
    ...
    print(f"Items extracted: {len(all_records)}")
